...
- [AgentLens](https://github.com/Soufianeazz/agentlens) - ![Repo stars of Soufianeazz/agentlens](https://img.shields.io/github/stars/Soufianeazz/agentlens?style=social) - Open-source, self-hosted LLM observability with quality scoring, hallucination detection, cost tracking, and agent trace debugging.
